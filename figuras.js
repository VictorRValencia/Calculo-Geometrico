...
function cuadrado2(){
    ...
    alert(`El perímetro del cuadrado es: ${perimetroC}cm \nEl área es: ${areaC}cm^2`);
}
...
function triangulo2(){
    ...
    alert(`El perímetro del triangulo es: ${tPerimetro}cm \nEl área es de ${tArea}cm^2`);
...
function circulo2(){
    ...
    alert(`El perímetro del circulo es: ${perimetroCi}cm  \nEl área es: ${areaCi}cm^2`);
}
